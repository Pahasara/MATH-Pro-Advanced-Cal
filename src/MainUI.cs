...
namespace DvNET_Math_Pro
{
    public partial class MainUI : Form
    {
        ...
        private void OutputTextCopyBtn_Click(object sender, EventArgs e)
        {
            try
            {
                memory = Double.Parse(Memory.Text) + Double.Parse(Output.Text);
                Memory.Text = memory.ToString();
            }
        ...
        private void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (operation == "VrectangleBox")
                {
                    ...
                    Print("Volume of the Rectangle Cube >>>");
                    Output.Text = result.ToString();
                }
                ...
                else if (operation == "VcircularCone")
                {
                    ...
                    Print("Volume of the Circular Cone >>>");
                    Output.Text = result.ToString();
                }
        ...
        /***************************                         *  PUBLIC FUNCTIONS  *                            *************************/
        public void Print(string Text) { OutputTextFieldBack.BackColor = Color.FromArgb(0,70,24); OutputTextField.ForeColor = Color.FromArgb(62, 209, 24); OutputTextField.Text += Text; OutputTextFieldBack.BackColor = Color.FromArgb(0, 0, 0); }
        public void Printerr(string Text) { OutputTextField.ForeColor = Color.FromArgb(241, 0, 0); OutputTextField.Text = Text; }
        public void Submit() { SubmitBtn.Enabled = true; }
        public void xSubmit() { SubmitBtn.Enabled = false; mMinusBtn.Enabled = true; mPlusBtn.Enabled = true; }
        /*******************************************************************************************************************************/
    }
}